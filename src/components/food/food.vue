    ...
    <div class="food" v-show="showFlag" ref="food">
        <div class="food-content">
            ...
            <div class="content">
                ...
                <div class="detail">
                    <span class="sell-count">月售出{{food.sellCount}}份</span>
                    ...
                    <ul v-show="food.ratings && food.ratings.length">
                        <li v-show="needShow(rating.rateType,rating.text)" v-for="(rating,index) in food.ratings" :key="index" class="rating-item border-1px">
                            <div class="user">
                                ...
                                <img width="12" height="12" :src="rating.avatar" alt="头像" class="avatar">
                            </div>
                            <div class="time">{{rating.rateTime | formatDate}}</div>
                            <p class="text">
                                <span :class="{'icon-thump_up':rating.avatar === 0,'icon-thump_down':rating.rateType === 1}"></span>{{rating.text}}
                            </p>
                        </li>
                    </ul>
